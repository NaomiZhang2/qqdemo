package com.social.qqdemo.api.impl;
...
public class QQImpl extends AbstractOAuth2ApiBinding implements QQ {
    ...
    public QQImpl(String accessToken, String appId) {
        ...
        System.out.println("【QQImpl】 QQ_URL_GET_OPENID={} result={}" + QQ_URL_GET_OPENID + result);
    ...
    public QQUserInfo getUserInfo() {
        ...
        System.out.println("【QQImpl】 QQ_URL_GET_USER_INFO={} result={}" + QQ_URL_GET_USER_INFO + result);
